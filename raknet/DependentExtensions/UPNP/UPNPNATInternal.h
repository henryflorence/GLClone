...
public:
	...
	UPNPNATInternal();
	UPNPNATInternal(RakNet::RakString whichInterface, RakNet::TimeMS connectToRouterTimeout=1000);
	~UPNPNATInternal(void);

	/// Restart the system
	void Restart(RakNet::RakString whichInterface, RakNet::TimeMS connectToRouterTimeout=1000);
