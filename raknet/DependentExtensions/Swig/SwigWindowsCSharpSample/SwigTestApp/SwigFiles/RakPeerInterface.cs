...
public class RakPeerInterface : IDisposable {
  ...
  public virtual void ReleaseSockets(SWIGTYPE_p_DataStructures__ListT_RakNetSmartPtrT_RakNet__RakNetSocket_t_t sockets) {
    RakNetPINVOKE.RakPeerInterface_ReleaseSockets(swigCPtr, SWIGTYPE_p_DataStructures__ListT_RakNetSmartPtrT_RakNet__RakNetSocket_t_t.getCPtr(sockets));
    if (RakNetPINVOKE.SWIGPendingException.Pending) throw RakNetPINVOKE.SWIGPendingException.Retrieve();
  }
