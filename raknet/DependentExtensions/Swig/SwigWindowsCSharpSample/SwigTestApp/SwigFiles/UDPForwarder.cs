...
public class UDPForwarder : IDisposable {
  ...
  public UDPForwarderResult AddForwardingEntry(SWIGTYPE_p_RakNet__UDPForwarder__SrcAndDest srcAndDest, uint timeoutOnNoDataMS, SWIGTYPE_p_unsigned_short port, string forceHostAddress) {
    UDPForwarderResult ret = (UDPForwarderResult)RakNetPINVOKE.UDPForwarder_AddForwardingEntry(swigCPtr, SWIGTYPE_p_RakNet__UDPForwarder__SrcAndDest.getCPtr(srcAndDest), timeoutOnNoDataMS, SWIGTYPE_p_unsigned_short.getCPtr(port), forceHostAddress);
    if (RakNetPINVOKE.SWIGPendingException.Pending) throw RakNetPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
