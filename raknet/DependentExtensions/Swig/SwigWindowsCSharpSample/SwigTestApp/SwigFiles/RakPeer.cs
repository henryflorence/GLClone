...
public class RakPeer : RakPeerInterface {
  ...
  public override void ReleaseSockets(SWIGTYPE_p_DataStructures__ListT_RakNetSmartPtrT_RakNet__RakNetSocket_t_t sockets) {
    RakNetPINVOKE.RakPeer_ReleaseSockets(swigCPtr, SWIGTYPE_p_DataStructures__ListT_RakNetSmartPtrT_RakNet__RakNetSocket_t_t.getCPtr(sockets));
    if (RakNetPINVOKE.SWIGPendingException.Pending) throw RakNetPINVOKE.SWIGPendingException.Retrieve();
  }
