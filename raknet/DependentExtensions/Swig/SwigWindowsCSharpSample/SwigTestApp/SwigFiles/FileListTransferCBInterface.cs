...
public class FileListTransferCBInterface : IDisposable {
  ...
  public virtual bool OnDownloadComplete(SWIGTYPE_p_RakNet__FileListTransferCBInterface__DownloadCompleteStruct dcs) {
    bool ret = ((this.GetType() == typeof(FileListTransferCBInterface)) ? RakNetPINVOKE.FileListTransferCBInterface_OnDownloadComplete(swigCPtr, SWIGTYPE_p_RakNet__FileListTransferCBInterface__DownloadCompleteStruct.getCPtr(dcs)) : RakNetPINVOKE.FileListTransferCBInterface_OnDownloadCompleteSwigExplicitFileListTransferCBInterface(swigCPtr, SWIGTYPE_p_RakNet__FileListTransferCBInterface__DownloadCompleteStruct.getCPtr(dcs)));
    return ret;
  }
  ...
  private bool SwigDirectorOnDownloadComplete(IntPtr dcs) {
    return OnDownloadComplete((dcs == IntPtr.Zero) ? null : new SWIGTYPE_p_RakNet__FileListTransferCBInterface__DownloadCompleteStruct(dcs, false));
  }
  ...
  private static Type[] swigMethodTypes3 = new Type[] { typeof(SWIGTYPE_p_RakNet__FileListTransferCBInterface__DownloadCompleteStruct) };
