...
class RakNetPINVOKE {
  ...
  [DllImport("RakNet", EntryPoint="CSharp_RakPeerInterface_ReleaseSockets")]
  public static extern void RakPeerInterface_ReleaseSockets(HandleRef jarg1, HandleRef jarg2);
  ...
  [DllImport("RakNet", EntryPoint="CSharp_RakPeer_ReleaseSockets")]
  public static extern void RakPeer_ReleaseSockets(HandleRef jarg1, HandleRef jarg2);
  ...
  public static extern int UDPForwarder_AddForwardingEntry(HandleRef jarg1, HandleRef jarg2, uint jarg3, HandleRef jarg4, string jarg5);
