...
//non endian swapped versions:
#define writeShort(x, y, z)     {*((NLushort *)((NLbyte *)&x[y])) = z; y += 2;}
#define writeLong(x, y, z)      {*((NLulong  *)((NLbyte *)&x[y])) = z; y += 4;}
#define writeFloat(x, y, z)     {*((NLfloat  *)((NLbyte *)&x[y])) = z; y += 4;}
#define writeDouble(x, y, z)    {*((NLdouble *)((NLbyte *)&x[y])) = z; y += 8;}
